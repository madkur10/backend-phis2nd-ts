...
const getClinicImpressionRequest = async (limit: string, emr_detail_id: string = "") => {
    let queryEmrDetail;
    let queryDate;
    ...
    const getDataPasien = `
        select
            ...
            bagian.nama_bagian,
            transaction_satu_sehat_encounter.key_satu_sehat Encounter_ID,
            emr_detail.emr_detail_id,
            emr_detail.objek_id,
            emr_detail.input_time input_time_emr,
            emr_detail.value summary,
            transaction_satu_sehat_clinicimpression.transaction_satu_sehat_id
        from
            registrasi
        ...
        inner join emr_detail on
            ...
            and emr_detail.objek_id = 226
            and emr_detail.status_batal is null
        inner join transaction_satu_sehat transaction_satu_sehat_encounter on
            registrasi.registrasi_id = transaction_satu_sehat_encounter.key_simrs
        ...
        where 
            ...
            and transaction_satu_sehat_encounter.key_satu_sehat <> '0'
            ${queryEmrDetail}
            ${queryDate}
            ${queryWhereTransaction}
...
const updateInsertIdClinicalImpressionRepo = async (
...
const updateUpdateIdClinicalImpressionRepo = async (
    emr_detail_id: bigint,
    payload: any,
    response: any,
    id: string,
